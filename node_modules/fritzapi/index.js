...
function Fritz(username, password, uri) {
	...
	if(this.username !== null && this.password !== null && this.password !== '')
	{
...
Fritz.prototype = {
    call: function(func) {
        ...
        return promise.then(function(sid) {
            ...
            return func.apply(null, [this.sid].concat(args)).catch(function(error) {
                if (typeof error === 'undefined' || (error.response && error.response.statusCode == 403)) {
	...
	{
		return module.exports.getSessionID(this.username, this.password, this.options);
	},
